...
//  Forage
//
//  Created by Ben Guo @ Stripe on 4/22/16.
//
//  Modified by Chandramouli Balasubramanian on 2/19/17.
...
class StripeCheckoutViewController: UIViewController, STPPaymentContextDelegate {
    ...
    let stripePublishableKey = "pk_test_DSRP1uClZ1ReyaDyvb8LFie9"
    
    let backendBaseURL: String? = Constants.FORAGE_SERVER + Constants.FORAGE_STRIPE_ENDPOINT
